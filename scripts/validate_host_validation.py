...
def validate(path: Path, deck: Path, expected_pages: int, *, strict: bool) -> dict[str, Any]:
...
def main() -> int:
    ...
    result = validate(Path(args.evidence).resolve(), Path(args.deck).resolve(), args.expected_pages, strict=args.strict)
