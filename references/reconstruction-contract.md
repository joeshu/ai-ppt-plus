...
- Replace a small generic icon only with a semantically equivalent vector that preserves meaning, weight and overall visual consistency; preserve branded graphics exactly or mark them manual.
