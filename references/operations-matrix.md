...
| editable authoring | JavaScript ESM, `@oai/artifact-tool`, OOXML inspection adapters | native text/shapes/charts/tables and movable assets | wrong object class, backend substitution or uneditable screenshot | authoring contract, L0-L5 object manifest and semantic audit |
