...
EXCLUDED_PATHS = [
    ...
    {"path": "assets/route-decision.template.json", "reason": "post-baseline outline-contract binding extension"},
    ...
    {"path": "references/perfect-replica-practice.md", "reason": "standalone repeatable practice protocol"},
    {"path": "scripts/build_perfect_sync_manifest.py", "reason": "standalone synchronization utility"},
    {"path": "scripts/component_expander.py", "reason": "post-baseline portable layout/component path resolution"},
    {"path": "scripts/compose_pptx.py", "reason": "post-baseline portable font-manifest resolution"},
    {"path": "scripts/compare_visual.py", "reason": "post-baseline pixel evidence hash binding"},
    {"path": "scripts/compare_visual_deck.py", "reason": "post-baseline deck pixel evidence hash binding"},
    {"path": "scripts/delivery_check.py", "reason": "post-baseline release evidence freshness gate"},
    ...
    {"path": "scripts/validate_project.py", "reason": "post-baseline root P0 governance integration"},
